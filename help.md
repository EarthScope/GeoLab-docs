# Help and Support
GeoLab is a growing platform and community. Our documentation is currently limited in scope, yet we value your questions and feedback. We want to help you be successful and leverage the platform to its full capacity. Chances are, if you're stuck, someone else is too &mdash; please ask! Your questions will help us evolve our documentation and resource offerings to best support the community's needs.
...
- soliciting help from other domain experts within the community, such as:
    - identifying and accessing appropriate datasets for your work in GeoLab
    - troubleshooting your notebooks, code, or unexpected results
    - questions about cloud performance optimization for specific research tasks
- providing your insight, expertise, and mentorship to other GeoLab users

Please note that this forum is public. It is the best avenue for questions that might be relevant to others in the geosciences, and/or can be answered by peers in the research community. However, if you are trying to reach a staff adminstrator, please email the help desk before posting on the forum. 

Log in to to the Community Forum [HERE]({{ discourse }}) using your EarthScope User Account.
...
- problems with server launches, crashes, and technical infrastructure bug reports that require GeoLab administrator intervention (please check the forum first to see if there is an outage report or if others have already resolved similar problems)
